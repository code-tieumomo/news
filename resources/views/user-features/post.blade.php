...
@section('title', 'Posts | User Features')
                            ...
                            <tbody>
                                @foreach ($posts as $post)
                                    <tr id="{{ $post->id }}">
                                        ...
                                        <td>
                                            <a href="/user-features/manage-post/{{ $post->id }}" class="btn btn-info"><i class="fa fa-pencil-square-o"></i> Edit</a>
