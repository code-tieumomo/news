            ...
            <div class="page-main">
                ...
                <aside class="app-sidebar">
                    <div class="app-sidebar__logo">
                        <a class="header-brand" href="{{ route('user-features.index') }}">
                    ...
                    <ul class="side-menu app-sidebar3">
                        <li class="side-item side-item-category mt-4">Infomation</li>
                        <li class="slide">
                            <a id="menu-dashboard" class="side-menu__item" href="{{ route('user-features.index') }}">
                                    ...
                                    <div class="d-flex order-lg-2 ml-auto">
                                        ...
                                        <div class="dropdown profile-dropdown">
                                            <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                                <span>
                                                    <img src="{{ asset('client-assets/images/users/user-sample.png') }}" alt="img" class="avatar avatar-md brround">
                                                </span>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                                                ...
                                                <a class="dropdown-item d-flex" href="{{ route('home.index') }}">
                                                    ...
                                                    <div class="">Back to UET-News</div>
                                                </a>
