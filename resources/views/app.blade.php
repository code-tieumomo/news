...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="text/png" href="{{ asset('client-assets/images/shortcut-icon.png') }}">
        <!-- Bootstrap -->
        <link rel="stylesheet" href="{{ asset('client-assets/scripts/bootstrap/bootstrap.min.css') }}">
        <!-- IonIcons -->
        <link rel="stylesheet" href="{{ asset('client-assets/scripts/ionicons/css/ionicons.min.css') }}">
        <!-- Toast -->
        <link rel="stylesheet" href="{{ asset('client-assets/scripts/toast/jquery.toast.min.css') }}">
        <!-- OwlCarousel -->
        <link rel="stylesheet" href="{{ asset('client-assets/scripts/owlcarousel/dist/assets/owl.carousel.min.css') }}">
        <link rel="stylesheet" href="{{ asset('client-assets/scripts/owlcarousel/dist/assets/owl.theme.default.min.css') }}">
        <!-- Magnific Popup -->
        <link rel="stylesheet" href="{{ asset('client-assets/scripts/magnific-popup/dist/magnific-popup.css') }}">
        <link rel="stylesheet" href="{{ asset('client-assets/scripts/sweetalert/dist/sweetalert.css') }}">
        <!-- Custom style -->
        <link rel="stylesheet" href="{{ asset('client-assets/css/style.css') }}">
        <link rel="stylesheet" href="{{ asset('client-assets/css/skins/all.css') }}">
    ...
    <body class="skin-orange">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12">
                            <div class="brand">
                                <a href="index.html">
                                    <img src="{{ asset('client-assets/images/logo.png') }}" alt="UET-News Logo">
                                </a>
                            </div>                      
                        </div>
                            ...
                            <form class="search" autocomplete="off">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" name="search-key" class="form-control" placeholder="Type something here">
                ...
                <div class="container">
                    ...
                    <div id="menu-list">
                        <ul class="nav-list">
                            ...
                            <li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">All Category <i class="ion-ios-arrow-right"></i></a>
                            ...
                            @foreach ($categories as $category)
                                <li class="dropdown magz-dropdown"><a href="#">{{ $category->name }} <i class="ion-ios-arrow-right"></i></a>
                        ...
                        <div class="block">
                            ...
                            <div class="block-body">
                                <figure class="foot-logo">
                                    <img src="{{ asset('client-assets/images/logo-light.png') }}" class="img-responsive" alt="Logo">
                                </figure>
                                <p class="brand-description">
                                    Dự án cuối khóa năm 2021.
                                </p>
                            ...
                            <div class="block-body">
                                <article class="article-mini">
                                    <div class="inner">
                                        <figure>
                                            <a href="single.html">
                                                <img src="{{ asset('client-assets/images/news/img12.jpg') }}" alt="Sample Article">
                                            </a>
                                        </figure>
                                        <div class="padding">
                                ...
                                <article class="article-mini">
                                    <div class="inner">
                                        <figure>
                                            <a href="single.html">
                                                <img src="{{ asset('client-assets/images/news/img14.jpg') }}" alt="Sample Article">
                                            </a>
                                        </figure>
                                        <div class="padding">
                                ...
                                <article class="article-mini">
                                    <div class="inner">
                                        <figure>
                                            <a href="single.html">
                                                <img src="{{ asset('client-assets/images/news/img15.jpg') }}" alt="Sample Article">
                                            </a>
                                        </figure>
                                        <div class="padding">
                                ...
                                <article class="article-mini">
                                    <div class="inner">
                                        <figure>
                                            <a href="single.html">
                                                <img src="{{ asset('client-assets/images/news/img16.jpg') }}" alt="Sample Article">
                                            </a>
                                        </figure>
                                        <div class="padding">
        ...
        <script src="{{ asset('client-assets/scripts/bootstrap/bootstrap.min.js') }}"></script>
        <script>var $target_end=$(".best-of-the-week");</script>
        <script src="{{ asset('client-assets/scripts/jquery-number/jquery.number.min.js') }}"></script>
        <script src="{{ asset('client-assets/scripts/owlcarousel/dist/owl.carousel.min.js') }}"></script>
        <script src="{{ asset('client-assets/scripts/magnific-popup/dist/jquery.magnific-popup.min.js') }}"></script>
        <script src="{{ asset('client-assets/scripts/sweetalert/dist/sweetalert.min.js') }}"></script>
        <script src="{{ asset('client-assets/scripts/toast/jquery.toast.min.js') }}"></script>
        <script src="{{ asset('client-assets/js/demo.js') }}"></script>
        <script src="{{ asset('client-assets/js/e-magz.js') }}"></script>
    </body>
</html>
